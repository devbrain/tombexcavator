...
static const char* header_to_string(archive::explode::exe_file::header_t h)
{
    switch (h)
    {
        case archive::explode::exe_file::SIGNATURE:
            return "SIGNATURE";
        case archive::explode::exe_file::NUM_OF_BYTES_IN_LAST_PAGE:
            return "NUM_OF_BYTES_IN_LAST_PAGE";
        case archive::explode::exe_file::NUM_OF_PAGES:
            return "NUM_OF_PAGES";
        case archive::explode::exe_file::RELLOCATION_ENTRIES:
            return "RELLOCATION_ENTRIES";
        case archive::explode::exe_file::HEADER_SIZE_PARA:
            return "HEADER_SIZE_PARA";
        case archive::explode::exe_file::MIN_MEM_PARA:
            return "MIN_MEM_PARA";
        case archive::explode::exe_file::MAX_MEM_PARA:
            return "MAX_MEM_PARA";
        case archive::explode::exe_file::INITIAL_SS:
            return "INITIAL_SS";
        case archive::explode::exe_file::INITIAL_SP:
            return "INITIAL_SP";
        case archive::explode::exe_file::CHECKSUM:
            return "CHECKSUM";
        case archive::explode::exe_file::INITIAL_IP:
            return "INITIAL_IP";
        case archive::explode::exe_file::INITIAL_CS:
            return "INITIAL_CS";
        case archive::explode::exe_file::RELLOC_OFFSET:
            return "RELLOC_OFFSET";
        case archive::explode::exe_file::OVERLAY_NUM:
            return "OVERLAY_NUM";
        case archive::explode::exe_file::MAX_HEADER_VAL:
            return "<UNKNOWN>";
    }
    return "";
}

namespace archive::explode
{
    ...
    // ========================================================
    input_exe_file::input_exe_file(archive::input& file)
            : m_file(file)
    {
        union
        {
    ...
    // --------------------------------------------------------
    archive::input& input_exe_file::file()
    {
        return m_file;
    }
    // ===================================================================
    ...
    // ------------------------------------------------------------------
    void full_exe_file::write(archive::output& out) const
    {
