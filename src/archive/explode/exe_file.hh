#ifndef ARCHIVE_EXPLODE_EXE_FILE_HH__
#define ARCHIVE_EXPLODE_EXE_FILE_HH__
...
namespace archive
{
    ...
    namespace explode
    {
        ...
        ARCHIVE_API std::ostream& operator<<(std::ostream& os, exe_file::header_t h);

        // ==============================================================
        class ARCHIVE_API input_exe_file : public exe_file
        {
        public:
            explicit input_exe_file(archive::input& file);
        ...
        struct ARCHIVE_API rellocation
        {
            rellocation()
                    : rel(0), seg(0)
            {
        ...
        class ARCHIVE_API output_exe_file : public exe_file
        {
        public:
        ...
        public:
            ...
            virtual void write(archive::output& out) const = 0;
        private:
...
// ====================================================================
        class ARCHIVE_API full_exe_file : public output_exe_file
        {
        public:
            ...
            virtual void write(archive::output& out) const;
        private:
#if defined(_MSC_VER)
#pragma warning (push)
#pragma warning (disable:4251)
