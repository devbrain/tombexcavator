...
namespace formats
{
    namespace explode
    {
        ...
        FORMATS_API std::ostream& operator<<(std::ostream& os, exe_file::header_t h);

        // ==============================================================
        class FORMATS_API input_exe_file : public exe_file
        {
        public:
        ...
        class FORMATS_API output_exe_file : public exe_file
        {
        public:
...
// ====================================================================
        class FORMATS_API full_exe_file : public output_exe_file
        {
        public:
