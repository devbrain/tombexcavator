...
struct file_impl_s
{
  file_impl_s (vfs::inode_num_t      my_inode, 
	       vfs::inode_num_t      parent_inode, 
	       westwood::pak_file_c* pak_file, 
...
file_impl_s::file_impl_s (vfs::inode_num_t      my_inode, 
			  vfs::inode_num_t      parent_inode, 
			  westwood::pak_file_c* pak_file, 
			  const provider::resource_c& resource)
  : m_my_inode     (my_inode),
...
// ------------------------------------------------------------------
std::string file_c::name () const
{
  return m_pimpl->m_resource.name ();
}
