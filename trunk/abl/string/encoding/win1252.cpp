...
namespace abl 
{
  const char* win1252_encoding_c::_names[] =
    {
      "Windows-1252",
      "CP1252",
      NULL
  ...
  const text_encoding_c::CharacterMap win1252_encoding_c::_charMap = 
    {
  ...
  win1252_encoding_c::win1252_encoding_c()
  {
  }
  ...
  const char* win1252_encoding_c::canonicalName() const
  {
    return _names[0];
  }


  bool win1252_encoding_c::isA(const std::string& encodingName) const
  {
  ...
  const text_encoding_c::CharacterMap& win1252_encoding_c::characterMap() const
  {
    return _charMap;
  }


  int win1252_encoding_c::convert(const unsigned char* bytes) const
  {
    return _charMap[*bytes];
  }


  int win1252_encoding_c::convert(int ch, unsigned char* bytes, int length) const
  {
  ...
  int win1252_encoding_c::queryConvert(const unsigned char* bytes, int length) const
  {
    if (1 <= length)
      return _charMap[*bytes];
    else
  ...
  int win1252_encoding_c::sequenceLength(const unsigned char* bytes, int length) const
  {
    return 1;
  }
