...
public class BossLevel4 extends Hostile implements Boss
{
	...
	private static final int WORM_PERIOD = 10000; // seems to depend on the difficulty level
	private int m_worm_timer = 0;
	...
	public class Boss4FireBall extends HostileWeapon 
	{
		...
		public void init() 
		{
			super.init(100, 5, m_params.level, m_params.hero,
