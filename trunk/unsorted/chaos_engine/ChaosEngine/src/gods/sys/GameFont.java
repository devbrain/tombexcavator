...
public class GameFont
{
	...
	public GameFont(String prefix) throws IOException
	{
		this(prefix,null,null,false);
	}
	public GameFont(String prefix, boolean fixed_font) throws IOException
	{
		this(prefix,null,null,fixed_font);
	}

		
	public GameFont(String prefix,Color original_white, Color white_replacement, boolean fixed_font) throws IOException
	{

		BufferedImage image = ImageLoadSave.load_png(prefix, Color.BLUE);
	...
	public GameFont(String prefix,Color monochrome_replacement,int border_rgb) throws IOException
	{
		m_fixed_font = false;
