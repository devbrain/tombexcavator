...
public class GodsCreditsScreen extends GameState {
	...
	public GodsCreditsScreen()
	{
	 ...
	 protected void p_init()
	 {
		 ...
		 try
		 {			 
			 m_golden_font = new GameFont(DirectoryBase.get_font_path()+"big_letters");
			 m_white_font = new GameFont(DirectoryBase.get_font_path()+"big_letters",Color.WHITE,0);
