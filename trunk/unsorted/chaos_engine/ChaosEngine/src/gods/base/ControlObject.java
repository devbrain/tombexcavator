...
public class ControlObject extends GfxObject implements EditorRenderable, Cloneable
{
	...
	public enum Type { Restart, Teleport_Destination, Bonus, Enemy_Trigger, Enemy, Face_Door, 
		Side_Door, Trap, Message_Trigger,
	...
	public static final Type [] TELEPORT_LOCATIONS = {Type.Restart, Type.Face_Door, Type.Teleport_Destination };
	public static final Type [] TRIGGERS = {Type.Enemy_Trigger, Type.Bonus, Type.Message_Trigger, Type.World_End_Trigger};
	...
	public ControlObject(ParameterParser fr, int x_resolution, int y_resolution, boolean scale2x) throws java.io.IOException
	{
