...
public class EditGfxPalette extends JPanel  implements MouseListener, Observer
{
	...
	private class PopupMenuEditActionAdapter implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) 
		{
			...
			case Delete_Frame:
				...
				break;
			case Edit:
				EditGfxFrameSet egf = new EditGfxFrameSet(m_parent, m_frame_set, EditGfxPalette.this, m_data.get_1x_image(),false);
	...
	private void create_gfx_frames(Rectangle r, boolean one_frame)
	{
		...
		if (nb_frames > 0)
		{
			...
			EditGfxFrameSet egf = new EditGfxFrameSet(m_parent, gfs, this, m_data.get_1x_image(), true);
