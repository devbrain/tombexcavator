...
{	
	...
	protected abstract T add_item(ParameterParser fr, int x_res, int y_res, GfxPaletteSet palette) throws IOException;

	protected LinkedList<T> m_object_list = new LinkedList<T>();
	
	protected void load(ParameterParser fr, GfxPaletteSet palette) throws IOException 
	{	
		...
		{
			add_item(fr,m_x_resolution,m_y_resolution,palette);
