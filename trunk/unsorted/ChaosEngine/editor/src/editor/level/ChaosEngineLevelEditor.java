...
public class ChaosEngineLevelEditor extends ChaosEngineEditor {
	...
	private JCheckBoxMenuItem jMenuViewFlags = new JCheckBoxMenuItem("Height & flags");
	
	public ChaosEngineLevelEditor() 
	{
		super("ChaosEngine Level editor", "LEVEL");
	...
	private class EditAssocActionListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			{
				AssociationDialog ad = new AssociationDialog(ChaosEngineLevelEditor.this,m_level_data);
				ad.setLocationRelativeTo(ChaosEngineLevelEditor.this);
				ad.setVisible(true);
			}
		}
	...
	private class CreateLevelActionListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			ChaosEngineEditor parent = ChaosEngineLevelEditor.this;
			...
			case Export:
				...
				if (fc.showOpenDialog(ChaosEngineLevelEditor.this) == JFileChooser.APPROVE_OPTION) 
				{			
	...
	private class ViewActionListener implements ActionListener
	{
		...
		private boolean m_flag_layer = false;
		
		private JCheckBoxMenuItem m_source;
		
		ViewActionListener(JCheckBoxMenuItem src)
		{
			m_flag_layer = true;
			m_source = src;
		}
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			if (m_flag_layer)
			{
				m_level_data.show_flags_layer(checked);
			}
			else
			{
			if (m_action_type != 0)
	...
	protected void init_widgets() throws Exception
	{
		...
		jMenuView.add(jMenuViewFlags);
		
		jMenuViewFlags.addActionListener(new ViewActionListener(jMenuViewFlags));
