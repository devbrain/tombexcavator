package base.associations;

import base.*;
import sys.*;

public class TriggerItemDisplay2Association extends ObjectAssociation 
{
	public TriggerItemDisplay2Association()
	{
		super(Type.Trigger_Item_Display,2);
	}
	@Override
	public String describe()
	{
		return "if hero walks into \""+get_trigger().get_name()+"\" then display \""+get_item_to_display().get_name()+"\"";
	}
	@Override
