...
public abstract class FlyingMonster extends LeftRightHostile {
	...
	private int m_angle;
	private Locatable m_circular_aim;
	private Locatable m_previous_position;
	...
	private Locatable m_drop_location = null;
	...
	protected void move(long elapsed_time) 
	{
		...
		if (m_current_path != null)
		{
			...
			Locatable original_aim = m_current_path.get_location();
	...
	private int closest_weapon(Locatable l)
	{
	...
	class SimpleLocation extends Locatable
	{
