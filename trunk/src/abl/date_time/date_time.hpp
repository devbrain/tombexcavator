...
public:
  ...
  date_time_c (int year, int month, int day, int hour = 0, int minute = 0, int second = 0, int millisecond = 0, int microsecond = 0);
  /// Creates a date_time_c for the given Julian day.
  date_time_c (double julianDay);
		
  /// Creates a date_time_c from an utc_time_val_t and a TimeDiff.
  ///
  /// Mainly used internally by date_time_c and friends.

  date_time_c (time_stamp_c::utc_time_val_t utcTime, time_stamp_c::TimeDiff diff);
  ...
  ///   * millisecond is from 0 to 999.
  ///   * microsecond is from 0 to 999.
  date_time_c& assign (int year, int month, int day, int hour = 0, int minute = 0, int second = 0, int millisecond = 0, int microseconds = 0);
  ...
  time_stamp_c::utc_time_val_t utcTime () const;
...
protected:	
  ...
  static double toJulianDay (time_stamp_c::utc_time_val_t utcTime);
  ...
  static time_stamp_c::utc_time_val_t toUtcTime (double julianDay);
...
private:
  ...
  time_stamp_c::utc_time_val_t m_utcTime;
  short  m_year;
  short  m_month;
  short  m_day;
  short  m_hour;
