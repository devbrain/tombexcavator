...
namespace abl 
{
  ...
  const char* latin1_encoding_c::_names[] =
    {
      "ISO-8859-1",
      "Latin1",
      "Latin-1",
  ...
  const text_encoding_c::CharacterMap latin1_encoding_c::_charMap = 
    {
  ...
  latin1_encoding_c::latin1_encoding_c()
  {
  }
  ...
  const char* latin1_encoding_c::canonicalName() const
  {
    return _names[0];
  }


  bool latin1_encoding_c::isA(const std::string& encodingName) const
  {
  ...
  const text_encoding_c::CharacterMap& latin1_encoding_c::characterMap() const
  {
    return _charMap;
  }


  int latin1_encoding_c::convert(const unsigned char* bytes) const
  {
    return *bytes;
  }


  int latin1_encoding_c::convert(int ch, unsigned char* bytes, int length) const
  {
    if (ch >= 0 && ch <= 255)
      {
	if (bytes && length >= 1)
  ...
  int latin1_encoding_c::queryConvert(const unsigned char* bytes, int length) const
  {
    if (1 <= length)
      return *bytes;
    else
  ...
  int latin1_encoding_c::sequenceLength(const unsigned char* bytes, int length) const
  {
    return 1;
  }
