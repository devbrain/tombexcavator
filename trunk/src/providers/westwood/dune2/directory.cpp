...
// -----------------------------------------------------------------------------------------
directory_impl_s::directory_impl_s (vfs::inode_num_t parent_inode, vfs::inode_num_t my_inode)
...
// -----------------------------------------------------------------------------------------
std::size_t directory_c::read (std::size_t entry_num, std::string& name, vfs::inode_num_t& inode_num)
{
...
vfs::fs_object_c* directory_c::load_object (vfs::inode_num_t ino)
{
  ...
  return new file_c (this->owner (), ino, this->inode_num (), m_pimpl->m_pak_file, res);
}
