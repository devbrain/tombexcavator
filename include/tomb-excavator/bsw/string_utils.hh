...
#ifndef TOMBEXCAVATOR_STRING_UTILS_HH
#define TOMBEXCAVATOR_STRING_UTILS_HH
...
//
    ...
    struct i_char_traits : public std::char_traits<charT>
    {
        ...
        {
            while(n-- > 0 && ascii::to_lower(*s) != ascii::to_lower(a)) { ++s; }
            return s;
        }
    };
...
#endif //TOMBEXCAVATOR_STRING_UTILS_HH
