...
//
#define _dBSW_IMPLEMENT_BYTEORDER_NOOP_(op, type)       \
  inline type bsw::byte_order::op(type value)            \
  {                                                      \
    return value;                                        \
  }
#define _dBSW_IMPLEMENT_BYTEORDER_FLIP_(op, type)       \
  inline type bsw::byte_order::op(type value)            \
  {                                                      \
...
#define _dBSW_IMPLEMENT_BYTEORDER_NOOP(op)              \
    _dBSW_IMPLEMENT_BYTEORDER_NOOP_(op, int16_t)        \
    _dBSW_IMPLEMENT_BYTEORDER_NOOP_(op, uint16_t)       \
    _dBSW_IMPLEMENT_BYTEORDER_NOOP_(op, int32_t)        \
    _dBSW_IMPLEMENT_BYTEORDER_NOOP_(op, uint32_t)       \
    _dBSW_IMPLEMENT_BYTEORDER_NOOP_(op, int64_t)        \
    _dBSW_IMPLEMENT_BYTEORDER_NOOP_(op, uint64_t)

#define _dBSW_IMPLEMENT_BYTEORDER_FLIP(op)              \
    _dBSW_IMPLEMENT_BYTEORDER_FLIP_(op, int16_t)        \
    _dBSW_IMPLEMENT_BYTEORDER_FLIP_(op, uint16_t)       \
    _dBSW_IMPLEMENT_BYTEORDER_FLIP_(op, int32_t)        \
    _dBSW_IMPLEMENT_BYTEORDER_FLIP_(op, uint32_t)       \
    _dBSW_IMPLEMENT_BYTEORDER_FLIP_(op, int64_t)        \
    _dBSW_IMPLEMENT_BYTEORDER_FLIP_(op, uint64_t)


#if !TE_IS_LITTLE_ENDIAN
#define _dBSW_IMPLEMENT_BYTEORDER_BIG _dBSW_IMPLEMENT_BYTEORDER_NOOP
#define _dBSW_IMPLEMENT_BYTEORDER_LIT _dBSW_IMPLEMENT_BYTEORDER_FLIP
#else
#define _dBSW_IMPLEMENT_BYTEORDER_BIG _dBSW_IMPLEMENT_BYTEORDER_FLIP
#define _dBSW_IMPLEMENT_BYTEORDER_LIT _dBSW_IMPLEMENT_BYTEORDER_NOOP
#endif


_dBSW_IMPLEMENT_BYTEORDER_BIG (to_big_endian)
_dBSW_IMPLEMENT_BYTEORDER_BIG (from_big_endian)
_dBSW_IMPLEMENT_BYTEORDER_BIG (to_network)
_dBSW_IMPLEMENT_BYTEORDER_BIG (from_network)
_dBSW_IMPLEMENT_BYTEORDER_LIT (to_little_endian)
_dBSW_IMPLEMENT_BYTEORDER_LIT (from_little_endian)
