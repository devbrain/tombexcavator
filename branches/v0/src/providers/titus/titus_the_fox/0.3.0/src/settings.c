...
int readconfig(char *configfile) {
    ...
    while(fgets(line, 299, ifp) != NULL)
    {
        ...
        if ((line[0] == 0) || (tmp[0] == *"#"))
            ...
            printf("Warning: unspecified command %s\n", tmp);
...
int initcodes() {
    strcpy (levelcode[0], "0000");
    strcpy (levelcode[1], "1111");
    strcpy (levelcode[2], "2222");
    strcpy (levelcode[3], "3333");
    strcpy (levelcode[4], "4444");
    strcpy (levelcode[5], "5555");
    strcpy (levelcode[6], "6666");
    strcpy (levelcode[7], "7777");
    strcpy (levelcode[8], "8888");
    strcpy (levelcode[9], "9999");
    strcpy (levelcode[10], "AAAA");
    strcpy (levelcode[11], "BBBB");
    strcpy (levelcode[12], "CCCC");
    strcpy (levelcode[13], "DDDD");
    strcpy (levelcode[14], "EEEE");
    strcpy (levelcode[15], "FFFF");
    return 0;
}
