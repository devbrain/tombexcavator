...
namespace abl 
{
  ...
  const char* latin9_encoding_c::_names[] =
    {
      "ISO-8859-15",
      "Latin9",
      "Latin-9",
  ...
  const text_encoding_c::CharacterMap latin9_encoding_c::_charMap = 
    {
  ...
  latin9_encoding_c::latin9_encoding_c()
  {
  }
  ...
  const char* latin9_encoding_c::canonicalName() const
  {
    return _names[0];
  }


  bool latin9_encoding_c::isA(const std::string& encodingName) const
  {
  ...
  const text_encoding_c::CharacterMap& latin9_encoding_c::characterMap() const
  {
    return _charMap;
  }


  int latin9_encoding_c::convert(const unsigned char* bytes) const
  {
    return _charMap[*bytes];
  }


  int latin9_encoding_c::convert(int ch, unsigned char* bytes, int length) const
  {
  ...
  int latin9_encoding_c::queryConvert(const unsigned char* bytes, int length) const
  {
    if (1 <= length)
      return _charMap[*bytes];
    else
  ...
  int latin9_encoding_c::sequenceLength(const unsigned char* bytes, int length) const
  {
    return 1;
  }
