...
{	
	...
	public int health_enhancement_times_4;
			...
			HostileWeaponSet hws, int index, int difficulty_level)
	{
		...
		this.total_nb_hostiles_of_wave = hwp.object_to_drop.size();
		...
		// this is rather empiric, and probably not perfect, but
		...
		//
		this.health_enhancement_times_4 = (difficulty_level + 3);
		
		this.health_points = (hwp.health_points * this.health_enhancement_times_4) / 4;
		...
		this.score_points = gfs.get_properties().points;
		...
		ObjectToDrop o = hwp.object_to_drop.elementAt(index);
		if (o != null)
		{
