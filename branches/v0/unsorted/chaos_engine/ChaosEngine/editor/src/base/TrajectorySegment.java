...
import base.HostileTrajectory.Type;
...
public class TrajectorySegment implements Describable, Cloneable, TrajectorySegmentConstant
{
	...
	/* (non-Javadoc)
	 * @see base.TrajectorySegmentConstant#to_location()
	 */
	...
	public Locatable location = null;
	public int duration = 0;
	
	/* (non-Javadoc)
	 * @see base.TrajectorySegmentConstant#get_location()
	 */
	public Locatable get_location()
	{
		return location;
	}
	/* (non-Javadoc)
	 * @see base.TrajectorySegmentConstant#get_duration()
	 */
