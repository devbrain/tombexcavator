...
public abstract class ChaosEngineEditor extends JFrame implements Observer
{
	...
	public ChaosEngineEditor(String title, String recent_prefix)
	{
	...
	/*
	public ChaosEngineEditor(String tiles_file, String title,String recent_prefix)
	{
...
*/
	...
	public void about()
	{		
		AboutBox dlg = new AboutBox(this,"1.0",m_title,"JOTD","2007-2009");
	...
	{
		private ChaosEngineEditor.MenuActionType action;
