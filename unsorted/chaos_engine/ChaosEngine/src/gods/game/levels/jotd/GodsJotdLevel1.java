...
public class GodsJotdLevel1 extends GodsLevel 
{
	...
	protected void on_button_pressed(String button_name) {
		...
		{
			if (display("w3_fire_chrystal_special_bonus"))
			{
				print("special bonus");
				m_w3_secret_1 = true;
			...
			LeverActivationState state) 
	{
		...
		{
			if (m_hero.steal("w3_treasure_key"))
			{
	...
	protected boolean on_trigger_activated(String trigger_name) 
	{
		...
		{
			if ((get_clock() < 120) && (m_w1_puzzle_2_done))
			{
		...
		{
			display_health_and_lives_bonus("w1_health_lives_bonus",2);
		...
		{
			if (m_hero.steal("w2_pot_4") && m_hero.steal("w2_pot_3"))
			{
				print("special bonus");
				display("w2_pot_bonus");
			}
			if (m_hero.owns("w2_world_key"))
			{
		...
		{
			boolean owns_pot_1 = m_hero.steal("w2_pot_1");
			boolean owns_pot_2 = m_hero.steal("w2_pot_2");
			...
			if (rval)
			{
				...
				{
					display("w2_store_fire_chrystal");
					display("w2_store_water_chrystal",false);
					print("special bonus");
				}
			}
		}
		...
		else if (trigger_name.equals("w2_treasure_key_room_trigger_1"))
		{
			display("w2_treasure_teleport_back_1");
		}
		else if (trigger_name.equals("w2_treasure_key_room_trigger_2"))
		{
			display("w2_treasure_teleport_back_2");
		}
		else if (trigger_name.equals("w2_treasure_key_room_trigger_3"))
		{
			display("w2_treasure_teleport_back_3");
		}
		// world 3
		...
		else if (trigger_name.equals("w3_close_door_part_2"))
		{
			start_clock();
