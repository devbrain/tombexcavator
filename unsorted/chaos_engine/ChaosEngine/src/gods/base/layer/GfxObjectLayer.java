...
public class GfxObjectLayer extends SparseLayer<GfxObject> 
{
	...
	@Override
	protected GfxObject add_item(ParameterParser fr, int x_res, int y_res, GfxPalette palette,boolean scale2x) throws IOException
	{
		GfxObject rval = new GfxObject(fr,x_res,y_res,palette,scale2x);
	...
	public GfxObjectLayer(ParameterParser fr, GfxPalette palette, 
			int y_resolution, LevelData levelData, boolean scale2x) throws IOException
	{
		this(y_resolution);
		load(fr,palette,scale2x);
