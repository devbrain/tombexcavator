...
public class DirectoryBase 
{
  ...
  public static final String LEVEL_EXTENSION = ".clv";
  ...
  {
	  return get_root() + "bin" + File.separator + "chaosengine" + File.separator + "game" + 
  ...
  static public String get_snapshot_path()
  {
   ...
   static public void env_check() throws Exception
   {
       if (get_root() == null)
	   {
	       m_root = "D:\\jff_data\\jbproject\\ChaosEngine\\";
