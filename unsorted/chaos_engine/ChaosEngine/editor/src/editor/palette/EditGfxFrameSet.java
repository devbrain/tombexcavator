...
import base.AnimatedFrames;
import base.GfxFrameSet;
import editor.DataModifier;
import editor.ViewGfxFrames;
...
public class EditGfxFrameSet extends JDialog implements DataModifier<GfxFrameSet> 
{
	...
	private JTextField jCodeTextField = null;
	...
	public void data_to_gui()
	{
		...
		getJWidthTextField().setText(m_data.get_width()+"");
		getJHeightTextField().setText(m_data.get_height()+"");
		...
		getJCodeTextField().setText(p.code);
		getJPointsTextField().setText(p.points+"");
		getJDescriptionTextField().setText(p.description);
		getJUpdateRateTextField().setText(p.update_rate+"");
	}
	public void gui_to_data() throws Exception
	{
		...
		p.code = getJCodeTextField().getText();
		p.description = getJDescriptionTextField().getText();			
		p.points = Integer.parseInt(getJPointsTextField().getText());
		p.update_rate = Integer.parseInt(getJUpdateRateTextField().getText());
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel9 = new JLabel();
			jLabel9.setBounds(new Rectangle(460, 62, 30, 23));
			jLabel9.setText("x");
			jLabel7 = new JLabel();
			...
			jContentPane.add(getJCodeTextField(), null);
			jContentPane.add(jLabel3, null);
			jContentPane.add(jLabel4, null);
			jContentPane.add(jLabel5, null);
			jContentPane.add(getJUpdateRateTextField(), null);
	 ...
	 * @return javax.swing.JTextField	
	 */
	private JTextField getJCodeTextField() {
		if (jCodeTextField == null) {
			jCodeTextField = new JTextField();
			jCodeTextField.setBounds(new Rectangle(68, 116, 123, 25));
		}
	...
	private JTextField getJWidthTextField() {
		if (jWidthTextField == null) {
			...
			jWidthTextField.setBounds(new Rectangle(420, 62, 30, 23));
	...
	private JTextField getJHeightTextField() {
		if (jHeightTextField == null) {
			...
			jHeightTextField.setBounds(new Rectangle(480, 62, 30, 23));
