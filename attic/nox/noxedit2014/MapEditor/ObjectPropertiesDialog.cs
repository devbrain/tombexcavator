	...
	public class ObjectPropertiesDialog : System.Windows.Forms.Form
	{
		...
		public Map.Object Object
		{
			...
			set
			{
                ...
                // AngryKirC: ставим флаги
                flagsListBox.SetItemChecked(0, (obj.CreateFlags & 2) == 2); // NO_UPDATE
                flagsListBox.SetItemChecked(1, (obj.CreateFlags & 0x20) == 0x20); // DESTROYED
                flagsListBox.SetItemChecked(2, (obj.CreateFlags & 0x40) == 0x40); // NO_COLLIDE
                flagsListBox.SetItemChecked(3, (obj.CreateFlags & 0x100) == 0x100); // EQUIPPED
                flagsListBox.SetItemChecked(4, (obj.CreateFlags & 0x8000) == 0x8000); // DEAD
                flagsListBox.SetItemChecked(5, (obj.CreateFlags & 0x1000000) == 0x1000000); // ENABLED
                flagsListBox.SetItemChecked(6, (obj.CreateFlags & 0x10000000) == 0x10000000); // NO_AUTO_DROP
		...
		private void buttonOK_Click(object sender, System.EventArgs e)
		{
			...
			uint[] flags = { 2, 0x20, 0x40, 0x100, 0x8000, 0x1000000, 0x10000000 };
			obj.CreateFlags = 0;
