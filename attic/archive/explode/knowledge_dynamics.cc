...
namespace archive::explode
{
            ...
            : m_file(inp.file())
    {
        ...
        {
            extra_data_start = static_cast <offset_type> (extra_data_start -
        ...
        archive::inmem_input mio(mzHeader2, 0x25);
        ...
        {
            extra_data_start2 = static_cast <offset_type> (extra_data_start2 -
    ...
    void knowledge_dynamics::unpack(output_exe_file& oexe)
    {
        ...
        while (true)
        {
            ...
            if (byte_pos >= MBUFFER_EDGE)
            {
                ...
                /* Copy leftovers */
                for (std::size_t j = 0; j < bytes_extra; j++)
